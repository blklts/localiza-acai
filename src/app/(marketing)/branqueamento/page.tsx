    ...
    >
        <div className="flex items-stretch w-full">
            <div className="w-full md:w-2/3 md:flex-shrink-0 flex flex-col gap-8 md:gap-[60px] self-center">
                <p className="text-muted text-base md:text-lg">O processo do branqueamento do açaí é um processo utilizado para garantir a segurança sanitária dentro da produção do açaí e assegurar o consumo seguro por parte dos consumidores.</p>
                <p className="text-muted text-base md:text-lg">Durante o processo, os frutos do açaí passam por uma rigorosa seleção, lavagem e sanitização com água tratada. Após essas etapas, o açaí é submetido rapidamente à água aquecida entre 80 °C a 90 °C por cerca de 10 segundos, sendo resfriado logo em seguida,  para evitar grandes alterações em seu sabor e textura.</p>
                <div className="flex items-center gap-4">
                    <p className="text-muted text-base md:text-lg flex-1">Atualmente, o processo do branqueamento é considerado requisito obrigatório para a segurança do açaí, com o intuito de reduzir a zero o número de infecções causadas por parte de doenças transmitidas por bactérias que contaminam o açaí.</p>
