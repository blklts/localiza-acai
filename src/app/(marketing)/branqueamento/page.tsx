    ...
    >
        <div className="flex items-stretch w-full">
            <div className="w-full md:w-2/3 md:flex-shrink-0 flex flex-col gap-8 md:gap-[60px] self-center">
                ...
                <p className="text-zinc-500 text-base md:text-lg">Atualmente, o processo do branqueamento é considerado requisito obrigatório para a segurança do açaí, com o intuito de reduzir a zero o número de infecções causadas por parte de doenças transmitidas por bactérias que contaminam o açaí.</p>
            </div>
            <div
