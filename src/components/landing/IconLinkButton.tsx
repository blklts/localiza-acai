...
export default function IconLinkButton({ href, iconSrc, label, className, hideLabel }: IconLinkButtonProps) {
  return (
    <Link
      href={href}
      className={`inline-flex items-center gap-2 bg-accent hover:bg-accent-hover text-white font-semibold rounded-lg px-4 py-3 transition-colors whitespace-nowrap${className ? ` ${className}` : ''}`}
    >
